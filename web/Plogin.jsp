    ...
    <script class="secret-source">
      ...
      <script>
          function validate()
            {
                alert("Log success");
                var name = document.myForm.pusername.value;
                var pass = document.myForm.ppassword.value;
...
<div class="wrap">
	...
	<div class="clear"></div>
        ...
        <form action="PatLog" method="post" name="myForm" onsubmit="return validate()">
...
<div id="login-box-name" style="margin-top:20px;">
    ...
    <input name="pusername" class="form-login" title="Username" value="" size="30" maxlength="2048" /></div>
    <div id="login-box-name">
    Password:</div><div id="login-box-field">
    <input name="ppassword" type="password" class="form-login" title="Password" value="" size="30" maxlength="2048" /></div>
<br />


<!---<a href=""><img src="images/login-btn.png" width="103" height="42" style="margin-left:90px;" /></a>--->
<center><input type="submit" value="submit">
    &nbsp;&nbsp;<a href="PReg.jsp">new register </a></center>
