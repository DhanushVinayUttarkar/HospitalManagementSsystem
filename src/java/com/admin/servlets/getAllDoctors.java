...
public class getAllDoctors extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String query = "SELECT distinct d_id,d_name FROM doctor where d_dept='"+id.replace(" ", "")+"' ";
            ...
            while(rs.next()){
                ...
                System.out.println(rs.getString("d_id")+" "+rs.getString("d_name"));
                obj.put("d_id", rs.getString("d_id"));
